...
$result = mysqli_query($conn, "SELECT mName, mMile, mIP, mDirect FROM avc_conf UNION SELECT mName, mMile, mIP, mDirect FROM dsrc_conf UNION SELECT mName, mMile, mIP, mDirect FROM ftms_vds_conf UNION SELECT mName, mMile, mIP, mDirect FROM ttms_vds_conf");
